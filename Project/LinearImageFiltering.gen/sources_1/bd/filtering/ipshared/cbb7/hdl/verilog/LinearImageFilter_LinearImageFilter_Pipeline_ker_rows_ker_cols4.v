...
reg   [0:0] tmp_4_reg_589;
reg    kernel_blk_n_R;
wire    ap_CS_fsm_pp0_stage3;
wire    ap_block_pp0_stage3;
reg   [0:0] tmp_4_reg_589_pp0_iter1_reg;
reg    image_in_blk_n_AR;
reg    image_in_blk_n_R;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1;
reg   [0:0] tmp_4_reg_589_pp0_iter2_reg;
...
reg   [0:0] tmp_4_reg_589_pp0_iter3_reg;
reg   [0:0] tmp_4_reg_589_pp0_iter4_reg;
reg  signed [31:0] newRow_4_reg_593;
wire   [29:0] trunc_ln50_fu_335_p1;
reg   [29:0] trunc_ln50_reg_598;
reg   [29:0] trunc_ln55_9_reg_603;
wire   [29:0] trunc_ln55_7_fu_398_p1;
reg   [29:0] trunc_ln55_7_reg_614;
...
wire   [31:0] bitcast_ln55_4_fu_443_p1;
reg   [31:0] mul21_4_reg_650;
reg   [31:0] sum_4_reg_660;
...
wire  signed [31:0] sext_ln55_4_fu_370_p1;
wire  signed [31:0] sext_ln55_fu_429_p1;
reg   [31:0] j_fu_106;
wire   [31:0] add_ln43_fu_380_p2;
wire    ap_loop_init;
reg   [31:0] i_fu_110;
reg   [63:0] indvar_flatten55_fu_114;
reg   [31:0] sum_fu_118;
...
wire   [31:0] add_ln39_4_fu_285_p2;
wire   [31:0] sub_ln48_fu_309_p2;
wire    ap_block_pp0_stage4;
wire   [29:0] trunc_ln55_8_fu_339_p1;
wire   [29:0] add_ln55_11_fu_342_p2;
wire   [31:0] shl_ln55_9_fu_347_p3;
wire   [31:0] add_ln55_12_fu_355_p2;
wire   [29:0] add_ln55_fu_402_p2;
wire   [31:0] shl_ln55_8_fu_406_p3;
wire   [31:0] add_ln55_10_fu_414_p2;
reg    grp_fu_224_ce;
reg    grp_fu_228_ce;
reg    grp_fu_232_ce;
reg    ap_done_reg;
...
#0 j_fu_106 = 32'd0;
#0 i_fu_110 = 32'd0;
#0 indvar_flatten55_fu_114 = 64'd0;
#0 sum_fu_118 = 32'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            indvar_flatten55_fu_114 <= 64'd0;
        end else if (((icmp_ln39_reg_540 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            indvar_flatten55_fu_114 <= add_ln39_reg_544;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sum_fu_118 <= 32'd0;
    end else if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter5 == 1'b1) & (tmp_4_reg_589_pp0_iter4_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        sum_fu_118 <= sum_4_reg_660;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        trunc_ln55_7_reg_614 <= trunc_ln55_7_fu_398_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mul21_4_reg_650 <= grp_fu_1990_p_dout0;
        p_cast_reg_535[30 : 0] <= p_cast_fu_236_p1[30 : 0];
        sum_4_reg_660 <= grp_fu_1986_p_dout0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ...
        trunc_ln55_s_reg_619 <= {{add_ln55_10_fu_414_p2[31:2]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        newRow_4_reg_593 <= grp_Pad_fu_1976_p_dout0_1;
        tmp_4_reg_589 <= grp_Pad_fu_1976_p_dout0_0;
        tmp_4_reg_589_pp0_iter1_reg <= tmp_4_reg_589;
        tmp_4_reg_589_pp0_iter2_reg <= tmp_4_reg_589_pp0_iter1_reg;
        tmp_4_reg_589_pp0_iter3_reg <= tmp_4_reg_589_pp0_iter2_reg;
        tmp_4_reg_589_pp0_iter4_reg <= tmp_4_reg_589_pp0_iter3_reg;
        trunc_ln50_reg_598 <= trunc_ln50_fu_335_p1;
        trunc_ln55_9_reg_603 <= {{add_ln55_12_fu_355_p2[31:2]}};
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter5 == 1'b1) & (tmp_4_reg_589_pp0_iter4_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ap_sig_allocacmp_sum_load_4 = sum_4_reg_660;
    end else begin
        ap_sig_allocacmp_sum_load_4 = sum_fu_118;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_fu_232_p0 = newRow_4_reg_593;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (tmp_4_reg_589 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (tmp_4_reg_589_pp0_iter2_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln39_reg_540 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_4_reg_589 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3) & (ap_enable_reg_pp0_iter2 == 1'b1) & (tmp_4_reg_589_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (tmp_4_reg_589 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (tmp_4_reg_589_pp0_iter2_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (tmp_4_reg_589_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
assign add_ln39_4_fu_285_p2 = (i_fu_110 + 32'd1);

assign add_ln39_fu_268_p2 = (indvar_flatten55_fu_114 + 64'd1);

assign add_ln43_fu_380_p2 = (select_ln24_reg_566 + 32'd1);

assign add_ln55_10_fu_414_p2 = (shl_ln55_8_fu_406_p3 + image_in_offset);

assign add_ln55_11_fu_342_p2 = (trunc_ln55_8_fu_339_p1 + trunc_ln55_reg_584);

assign add_ln55_12_fu_355_p2 = (shl_ln55_9_fu_347_p3 + kernel_offset);

assign add_ln55_fu_402_p2 = (trunc_ln55_7_reg_614 + trunc_ln50_reg_598);
...
always @ (*) begin
    ap_block_state14_pp0_stage3_iter2 = ((tmp_4_reg_589_pp0_iter1_reg == 1'd1) & (m_axi_kernel_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state14_pp0_stage3_iter2_ignore_call14 = ((tmp_4_reg_589_pp0_iter1_reg == 1'd1) & (m_axi_kernel_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state17_pp0_stage1_iter3 = ((tmp_4_reg_589_pp0_iter2_reg == 1'd1) & (m_axi_image_in_RVALID == 1'b0));
end
...
always @ (*) begin
    ap_block_state9_io = ((tmp_4_reg_589 == 1'd1) & (m_axi_image_in_ARREADY == 1'b0));
end
...
always @ (*) begin
    ap_predicate_op89_readreq_state6 = ((icmp_ln39_reg_540 == 1'd0) & (tmp_4_reg_589 == 1'd1));
end

assign bitcast_ln55_4_fu_443_p1 = kernel_addr_read_reg_630;
...
assign grp_fu_1986_p_din0 = ap_sig_allocacmp_sum_load_4;

assign grp_fu_1986_p_din1 = mul21_4_reg_650;
...
assign grp_fu_1990_p_din1 = bitcast_ln55_4_fu_443_p1;
...
assign icmp_ln39_fu_263_p2 = ((indvar_flatten55_fu_114 == mul_ln7) ? 1'b1 : 1'b0);
...
assign m_axi_kernel_ARADDR = sext_ln55_4_fu_370_p1;
...
assign newRow_fu_305_p2 = ($signed(add_4) + $signed(select_ln39_reg_559));

assign p_cast_fu_236_p1 = empty_29;

assign select_ln24_fu_299_p3 = ((icmp_ln43_reg_554[0:0] == 1'b1) ? 32'd0 : j_load_reg_549);

assign select_ln39_fu_291_p3 = ((icmp_ln43_fu_280_p2[0:0] == 1'b1) ? add_ln39_4_fu_285_p2 : i_fu_110);

assign sext_ln55_4_fu_370_p1 = $signed(trunc_ln55_9_reg_603);

assign sext_ln55_fu_429_p1 = $signed(trunc_ln55_s_reg_619);

assign shl_ln55_8_fu_406_p3 = {{add_ln55_fu_402_p2}, {2'd0}};

assign shl_ln55_9_fu_347_p3 = {{add_ln55_11_fu_342_p2}, {2'd0}};

assign sub_ln48_fu_309_p2 = (col_8 - p_cast_reg_535);

assign sum_13_out = sum_fu_118;

assign trunc_ln50_fu_335_p1 = grp_Pad_fu_1976_p_dout0_2[29:0];

assign trunc_ln55_7_fu_398_p1 = grp_fu_618_p_dout0[29:0];

assign trunc_ln55_8_fu_339_p1 = select_ln24_reg_566[29:0];
