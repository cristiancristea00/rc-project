...
HD_PWD='/home/cristi/Documents/ACES/RC-Project/Project/LinearImageFiltering.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log filtering_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source filtering_wrapper.tcl -notrace
