...
# IP: bd/system/ip/system_LinearImageFiltering_0_0/system_LinearImageFiltering_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_LinearImageFiltering_0_0 || ORIG_REF_NAME==system_LinearImageFiltering_0_0} -quiet] -quiet
