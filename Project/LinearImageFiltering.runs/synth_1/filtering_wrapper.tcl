...
namespace eval ::optrace {
  variable script "/home/cristi/Documents/ACES/RC-Project/Project/LinearImageFiltering.runs/synth_1/filtering_wrapper.tcl"
...
read_checkpoint -auto_incremental -incremental /home/cristi/Documents/ACES/RC-Project/Project/LinearImageFiltering.srcs/utils_1/imports/synth_1/filtering_wrapper.dcp
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top filtering_wrapper -part xc7z020clg400-1 -directive PerformanceOptimized -fsm_extraction one_hot -keep_equivalent_registers -resource_sharing off -no_lc -shreg_min_size 5
...
write_checkpoint -force -noxdef filtering_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file filtering_wrapper_utilization_synth.rpt -pb filtering_wrapper_utilization_synth.pb"
