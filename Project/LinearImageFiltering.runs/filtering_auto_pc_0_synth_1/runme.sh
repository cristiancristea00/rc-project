...
HD_PWD='/home/cristi/Documents/ACES/RC-Project/Project/LinearImageFiltering.runs/filtering_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filtering_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filtering_auto_pc_0.tcl
