...
HD_PWD='/home/cristi/Documents/ACES/RC-Project/Project/LinearImageFiltering.runs/filtering_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filtering_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filtering_xbar_0.tcl
