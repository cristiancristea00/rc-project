...
EAStep vivado -log system_LinearImageFiltering_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_LinearImageFiltering_0_0.tcl
