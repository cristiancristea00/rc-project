...
$(ObjDir)/Matrix.cpp_pre.cpp.tb.o : Matrix.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Matrix.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -std=c++17 -fno-builtin -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/LinearImageFilteringTestbench.cpp_pre.cpp.tb.o : LinearImageFilteringTestbench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling LinearImageFilteringTestbench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -std=c++17 -fno-builtin -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/LinearImageFiltering.cpp_pre.cpp.tb.o : LinearImageFiltering.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling LinearImageFiltering.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -std=c++14 -fno-builtin -std=c++14 -fno-builtin $(IFLAG) $(DFLAG) $< -o $@; \
