; ModuleID = '/home/cristian/Documents/ACES/RC-Project/HLS/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %kernel_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %image_out, float* nonnull align 512 %image_out_copy, float* nonnull %image_in, float* nonnull align 512 %image_in_copy, float* nonnull %kernel, float* nonnull align 512 %kernel_copy)
  call void @apatb_LinearImageFilter_hw(float* %image_out_copy, float* %image_in_copy, i32 %rows, i32 %cols, float* %kernel_copy, i32 %kernel_size, i32 %stride_row, i32 %stride_col, i8 %padding)
  call void @copy_back(float* %image_out, float* %image_out_copy, float* %image_in, float* %image_in_copy, float* %kernel, float* %kernel_copy)
  ret void
}
...
declare void @apatb_LinearImageFilter_hw(float*, float*, i32, i32, float*, i32, i32, i32, i8)
...
define void @LinearImageFilter_hw_stub_wrapper(float*, float*, i32, i32, float*, i32, i32, i32, i8) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1, float* null, float* %4)
  call void @LinearImageFilter_hw_stub(float* %0, float* %1, i32 %2, i32 %3, float* %4, i32 %5, i32 %6, i32 %7, i8 %8)
  call void @copy_in(float* null, float* %0, float* null, float* %1, float* null, float* %4)
  ret void
}
