...
set kernel_xo ""
set detect_deadlock_json "LinearImageFilter_message_dict.json"

## Variables
set Top "LinearImageFilter"
set TopNoPrefix "LinearImageFilter"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_image_out m_axi_image_in m_axi_kernel"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_image_out {
        ...
        data_width "32"
        port_prefix "m_axi_image_out"
        param_prefix "C_M_AXI_IMAGE_OUT"
...
source -notrace "/home/cristian/AMD/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
