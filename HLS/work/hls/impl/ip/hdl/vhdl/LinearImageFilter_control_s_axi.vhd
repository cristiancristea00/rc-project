...
entity LinearImageFilter_control_s_axi is
generic (
...
end entity LinearImageFilter_control_s_axi;
...
architecture behave of LinearImageFilter_control_s_axi is
    ...
    constant ADDR_IMAGE_OUT_OFFSET_DATA_0 : INTEGER := 16#10#;
    constant ADDR_IMAGE_OUT_OFFSET_CTRL   : INTEGER := 16#14#;
    constant ADDR_IMAGE_IN_OFFSET_DATA_0  : INTEGER := 16#18#;
    constant ADDR_IMAGE_IN_OFFSET_CTRL    : INTEGER := 16#1c#;
    constant ADDR_ROWS_DATA_0             : INTEGER := 16#20#;
    constant ADDR_ROWS_CTRL               : INTEGER := 16#24#;
    constant ADDR_COLS_DATA_0             : INTEGER := 16#28#;
    ...
    constant ADDR_STRIDE_COL_CTRL         : INTEGER := 16#4c#;
    constant ADDR_PADDING_DATA_0          : INTEGER := 16#50#;
    constant ADDR_PADDING_CTRL            : INTEGER := 16#54#;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_IMAGE_OUT_OFFSET_DATA_0 =>
                        rdata_data <= RESIZE(int_image_out_offset(31 downto 0), 32);
                    when ADDR_IMAGE_IN_OFFSET_DATA_0 =>
                        rdata_data <= RESIZE(int_image_in_offset(31 downto 0), 32);
                    ...
                    when ADDR_STRIDE_COL_DATA_0 =>
                        rdata_data <= RESIZE(int_stride_col(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    image_out_offset     <= STD_LOGIC_VECTOR(int_image_out_offset);
    image_in_offset      <= STD_LOGIC_VECTOR(int_image_in_offset);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMAGE_OUT_OFFSET_DATA_0) then
                    int_image_out_offset(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_image_out_offset(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMAGE_IN_OFFSET_DATA_0) then
                    int_image_in_offset(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_image_in_offset(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_OFFSET_DATA_0) then
                    int_kernel_offset(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_offset(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_STRIDE_ROW_DATA_0) then
                    int_stride_row(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_stride_row(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_STRIDE_COL_DATA_0) then
                    int_stride_col(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_stride_col(31 downto 0));
                end if;
            end if;
        end if;
    end process;
